...
% TODO:
% * consider the "Mathias alternative" for generator<non-reference>.
...
public:
  ...
  template<class T2, class Alloc2, class U2>
    requires same_as<typename generator<T2, Alloc2, U2>::@\exposid{yielded}@, @\exposid{yielded}@>
...
\begin{codeblock}
    auto nested = [](allocator_arg_t, Alloc2, auto* range_ptr)
      -> generator<@\exposid{yielded}@, Alloc2, ranges::range_value_t<R>> {
...
\begin{thebibliography}{9}
    ...
    \url{https://godbolt.org/z/oo75fTMc6}
